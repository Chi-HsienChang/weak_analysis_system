...
//     int bar_width = 50;  // 進度條寬度
//     cout << "[";
//     int pos = bar_width * progress;
//     for (int i = 0; i < bar_width; ++i) {
//         if (i < pos) cout << "=";  // 填充已完成部分
//         else if (i == pos) cout << ">";  // 當前進度點
//         else cout << " ";
//     }
//     cout << "] " << int(progress * 100.0) << "%\r";  // 顯示百分比
//     cout.flush();
// }
...
void show_progress_bar(double progress) {
    ...
    int pos = bar_width * progress;
    for (int i = 0; i < bar_width; ++i) {
        if (i < pos) std::cerr << "=";  // 填充已完成部分
        else if (i == pos) std::cerr << ">";  // 當前進度點
        else std::cerr << " ";
    }
